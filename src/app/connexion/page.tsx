...
// Formulaire de connexion, utilise signIn() de NextAuth avec le provider Credentials.
"use client";
  ...
  return (
    <main className="mx-auto max-w-sm px-4 py-16">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <input name="password" type="password" placeholder="Mot de passe" required className="rounded-lg border border-gray-200 px-3 py-2 text-sm" />
