...
// Affiche le solde de points et l'historique des transactions.

import { getServerSession } from "next-auth";
import { authOptions } from "@/lib/auth";
import { prisma } from "@/lib/prisma";
import { calculerReductionPoints, POINTS_PAR_100_FCFA } from "@/lib/fidelite";
  ...
  return (
    <div>
      <div className="carte-3d-forte mb-6 p-6 text-center">
        ...
        <p className="mt-1 text-sm text-encre/50">Équivalent à {formatPrix(calculerReductionPoints(points))}</p>
